...
public:
	...
	// Check if mesh is in the view frustum
	bool MeshInViewFrustum(const GLfloat MVPMatrix[16], const GLfloat &xPos, const GLfloat &yPos, const GLfloat &zPos, const GLfloat &radius)
	{
